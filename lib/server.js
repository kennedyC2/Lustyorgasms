...
server.unifiedServer = (req, res) => {
	...
	req.on("end", () => {
		...
		// if the request is within the webfonts directory, route to the webfonts handler
		chosenHandler = trimmedPath.indexOf("webfonts/") > -1 ? handler.webfont : chosenHandler;

		// if the request is within the favicon directory, route to the favicon handler
		chosenHandler = trimmedPath.indexOf("favicon/") > -1 ? handler.favicon : chosenHandler;

		// if the request is within the playVideo directory, route to the playVideo handler
		...
		// if the request is within the tag directory, route to the tag handler
		chosenHandler = trimmedPath.indexOf("tag/") > -1 ? handler.tagVideo : chosenHandler;

		// if the request is within the search directory, route to the search handler
		chosenHandler = trimmedPath.indexOf("search/") > -1 ? handler.search : chosenHandler;
