...
server.unifiedServer = function (req, res) {
	...
	req.on('end', function () {
		...
		//chosenHandler = trimmedPath.indexOf('getVideo/') > -1 ? handler.getVideo : chosenHandler;
		...
		// Send response
		chosenHandler(data, function (statusCode, message, contentType) {
			try {
...
// ================================================================================================
server.handlerProcessor = function (res, statusCode, message, contentType) {
	// Sanity check
...
server.router = {
	...
	'pornStars/list': handler.pornStarList,
	'getVideo': handler.getVideo,
	'video/topRated': handler.topRated,
	'video/mostViewed': handler.mostViewed,
	'video/recommended': handler.recommended,
	'video/new': handler.newVideos,
	'search': handler.search,
	'playVideo': handler.playVideo,
	'video/tag': handler.tagVideo,
